...
if ((isset($_POST['Num_clt'])) && ($_POST['Num_clt'] != "")) {
  $deleteSQL = sprintf("DELETE FROM distribition WHERE Num_clt=%s",
...
<?php do { ?>
  <form name="form1" method="post" action="">
    ...
    <label>
    <input name="textfield2" type="text" value="<?php echo $row_Recordset1['Num_prod']; ?>">
    </label>
    <label>
    <input name="textfield3" type="text" value="<?php echo $row_Recordset1['Quantite']; ?>">
    </label>
    <label>
    <input name="textfield4" type="text" value="<?php echo $row_Recordset1['Date_livraison']; ?>">
    </label>
    <label>
