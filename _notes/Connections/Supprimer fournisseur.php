...
if ((isset($_POST['Num_frs'])) && ($_POST['Num_frs'] != "")) {
  $deleteSQL = sprintf("DELETE FROM fournisseur WHERE Num_frs=%s",
                       GetSQLValueString($_POST['Num_frs'], "text"));
...
mysql_select_db($database_H_D_Industrie, $H_D_Industrie);
$query_Recordset1 = "SELECT * FROM fournisseur";
...
<?php do { ?>
  <form name="form1" method="post" action="">
    <label>
    <input name="Num_frs" type="text" id="Num_frs" value="<?php echo $row_Recordset1['Num_frs']; ?>">
    </label>
    <label>
